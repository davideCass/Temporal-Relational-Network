...
ROOT_DATASET = 'gdrive/My Drive/ML-Progetto/dataset/sport/'
ROOT_FOLDER = "gdrive/My Drive/ML-Progetto/dataset/sport/"
...
def return_sport(modality):
    filename_categories = "category.txt"
    if modality == 'RGB':
        prefix = '{:06d}.jpg'
        #root_data = '/data/vision/oliva/scratch/bzhou/video/jester/20bn-jester-v1'
        root_data = 'gdrive/My Drive/ML-Progetto/dataset/sport/frame-video'
        filename_imglist_train = "train_videofolder.txt" 
        filename_imglist_val = "val_videofolder.txt"
        filename_imglist_test = "test_videofolder.txt"
    elif modality == 'Flow':
        root_data = 'drive/ML-Progetto/dataset/sport/sport-frames'
        #root_data = '/mnt/localssd1/bzhou/something/flow'
        filename_imglist_train = 'sport/train_videofolder.txt'
        filename_imglist_val = 'sport/val_videofolder.txt'
        prefix = '{:05d}.jpg'
    else:
        print('no such modality:'+modality)
        os.exit()
...
def return_dataset(dataset, modality):
    dict_single = {'jester': return_jester, 'something': return_something, 'somethingv2': return_somethingv2,
                   'charades': return_charades, 'moments': return_moments, 'sport':return_sport}
    ...
    return categories, file_imglist_train, file_imglist_val, file_imglist_test, root_data, prefix
