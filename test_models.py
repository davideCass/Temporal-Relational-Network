...
parser = argparse.ArgumentParser(
    description="TRN testing on the full test set")
parser.add_argument('dataset', type=str, choices=['something','jester','moments','charades','sport'])
...
categories, args.train_list, args.val_list, args.test_list, args.root_path, prefix = datasets_video.return_dataset(args.dataset, args.modality)
...
for i, (data, label) in data_gen:
    ...
    prec1, prec5 = accuracy(torch.from_numpy(np.mean(rst[1], axis=0)), label, topk=(1, 3))
