...
def load_frames(frame_paths, num_frames=8):
    ...
    if len(frames) >= num_frames:
        ...
        raise ValueError('Video must have at least {} frames'.format(num_frames), '{}'.len(frames))
...
# options when launch command for testing
...
parser.add_argument('--dataset', type=str, default='moments',
                    choices=['something', 'jester', 'moments','sport'])
...
categories_file = 'gdrive/My Drive/ML-Progetto/dataset/{}/category.txt'.format(args.dataset)
