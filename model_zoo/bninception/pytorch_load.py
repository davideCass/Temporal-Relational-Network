...
class BNInception(nn.Module):
    def __init__(self, model_path='gdrive/My Drive/ML-Progetto/model_zoo/bninception/bn_inception.yaml', num_classes=101,
...
class InceptionV3(BNInception):
    def __init__(self, model_path='gdrive/My Drive/ML-Progetto/model_zoo/bninception/inceptionv3.yaml', num_classes=101,
